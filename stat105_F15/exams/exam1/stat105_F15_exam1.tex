...
%  Last Modified: Thu Oct  1 00:06:40 2015
%  Created By:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{parts}
   ...
   \begin{subparts}
      ...
      \vspace{2cm}
      \subpart[5] Using the fitted line, what do we suppose a person will guess their score will be if they actually scored a 40.1406097.
      \vspace{2cm}
      \subpart[2] A person who scored a 40.1406097 on the test predicted that they would score 49.5645555. What is the residual for this person using the linear relationship?
      \vspace{2cm}
   \end{subparts}
   ...
   \begin{subparts}
      ...
      \vspace{2cm}
      \subpart[2] A person who scored a 98.7392171 on the test predicted that they would score 63.5508124. What is the residual for this person using the quadratic relationship?
      \vspace{2cm}
   \end{subparts}
\end{parts}
