...
svm.res <- kable(table(pred = prediction, true = d$y[801:1000]), 
    format = "markdown")
{% endhighlight %}
...
svm.PC.res <- kable(table(pred = prediction, true = d.PC$y[801:1000]), 
    format = "markdown")
{% endhighlight %}
...
rf.res <- kable(table(pred = prediction, true = d$y[801:1000]), 
    format = "markdown")
{% endhighlight %}
...
rf.PC.res <- ktable(table(pred = prediction, true = d.PC$y[801:1000]), 
    format = "markdown")
{% endhighlight %}
...
{% highlight text %}
Error: could not find function "ktable"
{% endhighlight %}

the results are garbage:

{% highlight text %}
Error: object 'rf.PC.res' not found
{% endhighlight %}
