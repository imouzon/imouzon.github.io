...
In this part, I am going to ask you to perform an exploratory analysis in R of an interesting and complicated set of data. 
...
<<read_brfss_data, echo=FALSE, cache=FALSE, include = TRUE>>=
source("http://imouzon.github.io/stat430/hw4/read_brfss.R")
