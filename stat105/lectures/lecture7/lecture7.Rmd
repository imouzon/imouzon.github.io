...
<head>
   ...
   <meta name='description' content='Lecture 7: Linear Models'/>
</head>
   ...
   ```{r eval = TRUE, echo = FALSE, tidy = TRUE, fig.height = 1.5, fig.width = 3, dpi = 150}
      des1 <- c(74, 79, 77, 81, 68, 79, 81, 76, 81, 80, 80, 78, 88, 83, 79, 91, 79, 75, 74, 73)
      des2 <- c(65, 77, 78, 74, 76, 73, 71, 71, 86, 81, 76, 89, 79, 78, 77, 76, 72, 76, 75, 79)
