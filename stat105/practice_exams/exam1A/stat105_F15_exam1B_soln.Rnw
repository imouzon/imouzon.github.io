...
%  Last Modified: Wed Sep 30 17:12:39 2015
%  Created By:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   \begin{solution} 
      ...
      \begin{align*}
         Q(.75) &= x_i + (n p - i + 0.5) \cdot (x_{i+1} - x_i) \\
                &= x_{\Sexpr{ival2}} + (5 \cdot .75 - \Sexpr{ival2} + 0.5) \cdot (x_{\Sexpr{ival2 + 1}} - x_{\Sexpr{ival2}}) \\
                &= \Sexpr{q1[ival2]} + (\Sexpr{5 * .75 - ival2+ 0.5}) \cdot (\Sexpr{q1[ival2 + 1]} - \Sexpr{q1[ival2]}) \\
                &= \Sexpr{q1[ival2]} + (\Sexpr{5 * .75 - ival2 + 0.5}) \cdot (\Sexpr{q1[ival2 + 1] - q1[ival2]}) \\
                &= \Sexpr{q1[ival2]} + \Sexpr{(5 * .75 - ival2 + 0.5) * (q1[ival2 + 1] - q1[ival2])} \\
                &= \Sexpr{q1[ival2] + (5 * .75 - ival2 + 0.5) * (q1[ival2 + 1] - q1[ival2])} \\
      \end{align*} 

      So we get $\text{IQR} = Q(.75) - Q(.25) = \Sexpr{q1[ival2] + (5 * .75 - ival2 + 0.5) * (q1[ival2 + 1] - q1[ival2])} - \Sexpr{q1[ival] + (5 * .25 - 1 + 0.5) * (q1[ival + 1] - q1[ival])} = \Sexpr{(q1[ival2] + (5 * .75 - ival2 + 0.5) * (q1[ival2 + 1] - q1[ival2])) - (q1[ival] + (5 * .25 - 1 + 0.5) * (q1[ival + 1] - q1[ival]))}$
   \end{solution}
